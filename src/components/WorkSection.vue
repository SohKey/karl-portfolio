...
<template>
  <section id="work" class="relative min-h-screen w-full flex flex-col items-center justify-center text-center py-16 px-4 md:px-8 xl:px-20">
    <h3 class="text-3xl font-bold mb-12 pb-12 text-black" data-aos="fade-right">Mes Projets</h3>
    <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-8">
      <div v-for="(project, i) in projects" :key="i" class="bg-white border border-gray-200 rounded-xl shadow-md p-4 flex flex-col items-center w-full" data-aos="fade-up">
        <div
          class="w-full aspect-[4/3] bg-gray-100 rounded-lg flex items-center justify-center mb-4 border border-gray-200 overflow-hidden cursor-pointer transition-all duration-200"
